  ...
  <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
    <div className="p-4 sm:p-7 shadow-lg">
      <div className="text-center ">
        <h1 style={{color:"teal",fontFamily:"initial"}} className="  block text-3xl font-bold text-gray-800 dark:text-white">
         Admin Login
        </h1>
          ...
          <div className="grid gap-y-4">
            ...
            <div>
              <label style={{ fontFamily: "initial" }}
                htmlFor="email"
                className="block font-bold text-sm mb-2 dark:text-white"
              >
              Email
              </label>
            ...
            <button style={{ fontFamily: "initial" }}
              type="submit"
              className="w-full py-2 mt-4 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            >
             Login
            </button>
          </div>
